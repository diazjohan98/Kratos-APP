...
import './tablaTecnologiasAdminStyles.css';
...
export const TablaTecnologiasAdmin = ({ data, configuration, tableClass, tableBodyClass, tableHeaderClass }) => {
    ...
    return (
        <div className='tablaTecnologiaAdmin'>
                    ...
                    <tr>
                        {
                            cabeceras.map(cabecera => (
                                <th className='titleTablaHabilidades'
                                    key={cabecera[0]}
                                >
                                    {cabecera[1]}
                                </th>
                    ...
                    <div className='d-flex justify-content-center containerBotonesCrud'>
                        ...
                        <Modal show={mostrarModal} onHide={cerrarModal}>
                            <Modal.Header closeButton>
                                <Modal.Title className='titleModalEliminar'>¿Deseas eliminar la tecnologia?</Modal.Title>
                            </Modal.Header>
