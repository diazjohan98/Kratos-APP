...
import './tablaHabilidadesStyles.css';
...
export const TablaHabilidades = ({ data, configuration, tableClass, tableBodyClass, tableHeaderClass }) => {
    ...
    return (
        <div className='tablaDetallesHabilidades'>
